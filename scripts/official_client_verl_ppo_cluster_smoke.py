...
def main() -> None:
    ...
    try:
        ...
        create_future = post_json(
            ...
            "/create_model",
            {
                "session_id": "ppo-cluster-smoke",
                "model_seq_id": 1,
                "base_model": MILESTONE1_BASE_MODEL_ID,
                "backend_id": "verl-train",
                "batch_codec": "torch",
                "lora_config": {"rank": 16},
                "user_metadata": {"smoke": "official-client-verl-ppo"},
            },
        )
        ...
        before_future = post_json(
            base_url,
            "/save_state",
            {"model_id": model_id, "path": "mint://ppo-cluster/checkpoint-before.pt"},
        )
        ...
        rollout = post_json(
            ...
            "/rollout_sessions",
            {
                "rollout_session_id": "ppo-cluster-rollout-1",
        ...
        collect_payload = post_json(
            base_url,
            "/rollout_sessions/ppo-cluster-rollout-1/collect",
            {
                ...
                "metadata": {"group_id": "cluster-prompt-1", "algo": "ppo"},
            },
        )
        ...
        train_payload = post_json(
            base_url,
            "/rollout_sessions/ppo-cluster-rollout-1/train",
            {
        ...
        after_future = post_json(
            base_url,
            "/save_state",
            {"model_id": model_id, "path": "mint://ppo-cluster/checkpoint-after.pt"},
        )
