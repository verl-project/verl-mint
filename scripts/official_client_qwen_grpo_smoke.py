...
def main() -> None:
    ...
    try:
        ...
        create_future = post_json(
            ...
            "/create_model",
            {
                "session_id": "grpo-smoke",
                "model_seq_id": 1,
                "base_model": MILESTONE1_BASE_MODEL_ID,
                "backend_id": "qwen-train-local",
                "batch_codec": "torch",
                "lora_config": {"rank": 16},
                "user_metadata": {"smoke": "official-client-qwen-grpo"},
            },
        )
        ...
        before_future = post_json(
            base_url,
            "/save_state",
            {"model_id": model_id, "path": "mint://grpo-smoke/checkpoint-before.pt"},
        )
        ...
        rollout = post_json(
            ...
            "/rollout_sessions",
            {
                "rollout_session_id": "grpo-rollout-1",
                "inference_backend_id": "qwen-infer-local",
                "training_session_id": model_id,
                "metadata": {"algo": "grpo", "reference_model_path": before_payload["path"]},
            },
        )
        ...
        collect_payload = post_json(
            base_url,
            "/rollout_sessions/grpo-rollout-1/collect",
            {
        ...
        train_payload = post_json(
            base_url,
            "/rollout_sessions/grpo-rollout-1/train",
            {
        ...
        after_future = post_json(
            base_url,
            "/save_state",
            {"model_id": model_id, "path": "mint://grpo-smoke/checkpoint-after.pt"},
        )
